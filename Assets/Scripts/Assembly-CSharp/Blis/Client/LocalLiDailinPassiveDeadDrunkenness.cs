...
namespace Blis.Client
{
	...
	public class LocalLiDailinPassiveDeadDrunkenness : LocalSkillScript
	{
		...
		private const string Passive_Effect_On_Key = "passive_01_on";


		private const string Passive_Effect_On = "FX_BI_Dailin_Skill02B";


		private static readonly Color redColor = new Color32(238, 39, 0, byte.MaxValue);


		public override void Start()
		{
			PlayEffectChildManual(Self, "passive_01_on", "FX_BI_Dailin_Skill02B");
			LocalCharacter.ExtraPointBarSettingColor(redColor);
		...
		public override void Finish(bool cancel)
		{
			...
			LocalCharacter.ExtraPointBarSettingColor(null);
		}
