...
namespace Blis.Client
{
	...
	public class HartActive3_1 : LocalSkillScript
	{
		private const string Hart_Skill03_1 = "Hart_Skill03_1";
		...
		public override void Start()
		{
			...
			PlayEffectChildManual(Self, "Hart_Skill03_1", "FX_BI_Hart_Skill03_B");
		...
		public override void Finish(bool cancel)
		{
			...
			StopEffectChildManual(Self, "Hart_Skill03_1", false);
		}
		...
		public override string GetTooltipValue(SkillData skillData, int index)
		{
			switch (index)
			{
				...
				case 5:
				{
					...
					return GameDB.characterState.GetData(Singleton<HartSkillActive3Data>.inst.BuffState[num2]).duration
						.ToString();
				}
				case 6:
				{
					int num3 = evolutionLevel;
					if (num3 < 1)
					{
						num3 = 1;
					}

					return GameDB.characterState.GetData(Singleton<HartSkillActive3Data>.inst.BuffState[num3]).maxStack
						.ToString();
				}
				default:
					return "";
