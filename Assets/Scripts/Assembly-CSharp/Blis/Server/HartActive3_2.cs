...
namespace Blis.Server
{
	...
	public class HartActive3_2 : HartSkillScript
	{
		...
		public override IEnumerator Play(object extraData = null)
		{
			...
			bool flag;
			float num;
			Caster.MoveToDirectionForTime(direction, SkillRange, Singleton<HartSkillActive3Data>.inst.DashDuration_2,
				EasingFunction.Ease.EaseOutCubic, true, out vector, out flag, out num);
			yield return WaitForSeconds(Singleton<HartSkillActive3Data>.inst.DashDuration_2);
