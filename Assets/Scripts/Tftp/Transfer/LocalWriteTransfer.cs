...
namespace Tftp.Net.Transfer
{
	...
	internal class LocalWriteTransfer : TftpTransfer
	{
		...
		public LocalWriteTransfer(ITransferChannel connection, string filename, IEnumerable<TransferOption> options) : base(connection, filename, new StartIncomingWrite(options))
		{
		}
