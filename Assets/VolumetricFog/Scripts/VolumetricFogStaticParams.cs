...
{
    /// <summary>
    ///     Important: do not change these values directly as it's managed by inspector editor. This value needs to match the
    ///     value in VolumetricFogOptions.cginc file.
    /// </summary>
