	...
	partial class EditorUtils
    {
        ...
        public static GenericMenu GetPreferedTypesSelectionMenu(Type baseType, Action<Type> callback, GenericMenu menu = null, string subCategory = null, bool showAddTypeOption = false) {
            ...
            foreach ( var t in TypePrefs.GetPreferedTypesList(constrainType, true) ) {
                ...
                var finalType = isGenericDefinition && genericDefinitionType.CanBeMadeGenericWith(t) ? genericDefinitionType.MakeGenericType(t) : t;
                ...
                var finalListType = isGenericDefinition && genericDefinitionType.CanBeMadeGenericWith(listType) ? genericDefinitionType.MakeGenericType(listType) : listType;
                ...
                var finalDictType = isGenericDefinition && genericDefinitionType.CanBeMadeGenericWith(dictType) ? genericDefinitionType.MakeGenericType(dictType) : dictType;
